...
//    const char upnp_video[]     = "object.item.videoItem.movie";
    ...
    const char upnp_playlist[]  = "object.item.playlistItem";
    ...
    type_t types[]=
    {
        ...
        { 11,  undef, "m3u8",  NULL,  "application/x-mpegURL",         "http-get:*:application/x-mpegURL:*",        upnp_playlist, dlna_ext_none },
        { 12,  undef, "m3u",   NULL,  "audio/x-mpegurl",               "http-get:*:audio/x-mpegurl:*",              upnp_playlist, dlna_ext_none },
